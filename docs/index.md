...
| [topics/edge-to-edge.md](topics/edge-to-edge.md) | Android 15/16 edge-to-edge — 현행 설정, 인셋 처리, Play 지원 중단 API 경고 |
| [topics/follow-up-status.md](topics/follow-up-status.md) | 현재 후속 확인 항목 — 배포·실기기·SDK 도구 검증 대기 상태 |
